...
function pet_care_zone_scripts() {
	...
	wp_enqueue_style('pet-care-zone-font', pet_care_zone_font_url(), array());
...
function pet_care_zone_font_url(){
	$font_url = '';
	$pacifico = _x('on','Pacifico:on or off','pet-care-zone');
	$roboto = _x('on','Roboto:on or off','pet-care-zone');
